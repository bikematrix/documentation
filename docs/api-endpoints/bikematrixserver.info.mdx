...
Some Bikes have a Data Reference field (for a specific bike Brand, Model, Spec and Year). You can get all sizes for a specific Data Reference by calling **GetBikesByDataReference** passing in the specific **dataReference** parameter. By passing a Data Reference of 'trek-fuel-ex-97-2022' you return a list of bike sizes for the 'Trek 2022 Fuel EX 9.7'.
